...
'type'=>'file','inputDefaults' => array('label' => false,'div' => false)));?>
    ...
    <table class='none'>
     ...
     <tr>
       ...
       <td colspan="3"><?php echo $form->input('cidade_id'); ?></td>
     </tr>
     <tr>
       <td><label for="ImovelBairroId">Bairro:*</label></td>
       <td colspan="3"><?php echo $form->input('bairro_id'); ?></td>
     </tr>
     <tr>
    ...
    <tr>
     ...
     <tr>
      ...
      <td colspan="2"><?php
       ...
       <td><?php echo $form->error('Imovel.status'); ?></td>
     </tr>
     <tr>
  ...
  <fieldset>
   ...
   <div id="list_images">
    ...
    <?php foreach($this->data['Imovel']['foto_img'] as $item): ?>
     <div class="box">
      <?php echo $html->image('/img/imoveis/'.$item)."<br />\n"; ?>
      <?php echo $form->hidden('',array('name'=>'data[Imovel][foto_img][]','value'=>$item,'id'=>'ImovelFotoId'.$idx))."\n"; ?>
