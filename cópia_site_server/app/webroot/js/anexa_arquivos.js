...
jQuery(document).ready(function(){
  ...
  if(!empty(jQuery("#ImovelFoto"))){
    ...
    new AjaxUpload('ImovelFoto', {
			action: 'http://www.dmarkimoveis.com.br/imovels/manager_files',
      data: {qtde: qtde+1},
      name: 'foto',
      ...
      if(response.match("Erro")){
          ...
          image = "<img src='/img/imoveis/" + response + "' alt='' class='' /><br />";
...
function delete_image(obj){
  ...
  linha.hide('slow');
	...
	jQuery.ajax({
    type: "POST",
    url: 'http://www.dmarkimoveis.com.br/imovels/delete_file/'+file,
    async: false,
