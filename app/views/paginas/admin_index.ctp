...
<h2><?php __('Páginas');?></h2>
 <div class="filtro">
    ...
    <tr>
      ...
      <td><?php echo $form->input('name',array('class'=>'custom')); ?></td>
...
?>
	<tr<?php echo $class;?>>
		...
		<td><?php echo $pagina['Pagina']['name']; ?></td>
		<td><?php echo $pagina['Pagina']['titulo']; ?></td>

		<td class="actions">
			<?php echo $html->link(__('Ver', true), array('action' => 'admin_view', $pagina['Pagina']['id'])); ?>
