...
<fieldset>
  ...
  <?php echo $form->input('password',array('label'=>'Senha:*','maxlength'=>'15','value'=>'')); ?>
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Excluir', true), array('action' => 'admin_delete', $form->value('Usuario.id')), null, sprintf(__('Tem certeza que deseja excluir o registro  # %s?', true), $form->value('Usuario.id'))); ?></li>
